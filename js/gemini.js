...
const GEMINI_PROMPT_ANALYZE = "Analiza la etiqueta en la imagen con precisión. Extrae los datos y responde EXCLUSIVAMENTE en formato JSON plano (sin formato markdown) con la siguiente estructura: {\"universitySerial\":\"...\",\"deviceSerial\":\"...\",\"brand\":\"...\",\"model\":\"...\",\"type\":\"...\",\"specs\":{\"processor\":\"...\",\"ram\":\"...\",\"storage\":\"...\",\"screen\":\"...\",\"os\":\"...\",\"other\":\"...\"},\"notes\":\"...\",\"status\":\"Funcional\"}. Si no encuentras un valor, usa 'No detectado'. En el campo 'notes', centra tu descripción EXCLUSIVAMENTE en el estado físico del equipo (daños, desgaste, suciedad, faltantes) o detalles relevantes encontrados en la imagen; NO incluyas datos técnicos como consumo de energía, voltaje, temperatura o especificaciones eléctricas.";
